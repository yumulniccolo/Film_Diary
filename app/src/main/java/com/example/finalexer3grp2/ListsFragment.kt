...
class ListsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<View?>(R.id.fab_add_list)
            .setOnClickListener(View.OnClickListener { v: View? ->
                findNavController(v!!).navigate(R.id.action_mainFragment_to_addListFragment)
            })
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): ListsFragment {
